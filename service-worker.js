...
// v7: el panel de "todas las secciones" ahora es un panel flotante que se
// puede abrir/cerrar por completo (botón "Secciones" en la barra de
// filtros) en vez de ocupar siempre una franja fija abajo. Al ya no vivir
// dentro del layout normal, el mapa usa todo el alto disponible sin
// importar si el panel está abierto o cerrado.
const CACHE_NAME = "recorrido-colima-v7";
